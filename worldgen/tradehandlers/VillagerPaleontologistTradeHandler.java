package com.extviljuraaddon.worldgen.tradehandlers;
...
public class VillagerPaleontologistTradeHandler implements IVillageTradeHandler 
{
	...
	public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random rand) 
	{
        ...
        if(!isHalloween)
        {
        	addTrade(recipeList, rand, 0.7F, new Offer(ModItems.amber, 2), new Offer(Items.emerald, 6));
        	addTrade(recipeList, rand, 0.7F, new Offer(ModItems.growthSerum, 1), new Offer(Items.emerald, 1));
        
        	addTrade(recipeList, rand, 0.7F, new Offer(ModItems.fossil, 1), new Offer(Items.emerald, 4));
        }
        else
        {
